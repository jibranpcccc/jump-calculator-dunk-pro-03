...
import { Calculator, Target, TrendingUp, RotateCcw } from "lucide-react";
...
const DunkCalculator = () => {
  ...
  const calculateDunk = useCallback(() => {
    ...
    if (!heightNum || heightNum <= 0 || heightNum > 120) {
      setResult("⚠️ Please enter a valid height between 1-120 inches");
      setShowResult(true);
      return;
    }

    if (!reachNum || reachNum <= 0 || reachNum > 150) {
      setResult("⚠️ Please enter a valid reach between 1-150 inches");
      setShowResult(true);
      return;
    }

    if (!jumpNum || jumpNum < 0 || jumpNum > 60) {
      setResult("⚠️ Please enter a valid vertical jump between 0-60 inches");
      setShowResult(true);
      return;
    }
    ...
    console.log("Dunk calculation:", { heightNum, reachNum, jumpNum, maxReach, rimHeight });
        ...
        <CardContent className="space-y-6 p-8">
              ...
              {result.includes("Not quite") && (
                <div className="p-4 bg-blue-100 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-blue-600 mt-1">
                    Check out our vertical jump training tips to reach your goal!
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="text-center p-4 bg-gray-100 rounded-lg">
            <div className="text-sm text-gray-600 space-y-1">
              ...
              <p>📊 Formula: Height + Standing Reach + Vertical Jump ≥ 120 inches</p>
